module Sokoban
  def self.game(picture_indexes = [])
    Shoes.app title: "Sokoban", width: 1000, height: 600, resizable: false do
      ...
      ground_image_paths[4] = "../graphics/normal_elements/nothing.gif"
  ...
  def self.create_curosor(window, picture_indexes, ground)
    ...
    Sokoban::Player.new window, ground, "../graphics/normal_elements/smiley.gif", Sokoban::Position.new(start_image.style[:left], start_image.style[:top])
